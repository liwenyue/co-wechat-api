 ...
 */
exports.getSubscribeUser = function* (options) {
 ...
 */
exports.createTags = function* (name){
  var token = yield this.ensureAccessToken();
  // https://api.weixin.qq.com/cgi-bin/tags/create?access_token=ACCESS_TOKEN
  var url = this.prefix + 'tags/create?access_token=' + token.accessToken;
  var data = {
    tag: {
      name: name
    }
...
exports.getTags = function* (){
  ...
  var url = this.prefix + 'tags/get?access_token=' + token.accessToken;
 ...
 * @param {String} name 标签名
 */
exports.updateTag = function* (id, name) {
  var token = yield this.ensureAccessToken();
  // https://api.weixin.qq.com/cgi-bin/tags/update?access_token=ACCESS_TOKEN
  var url = this.prefix + 'tags/update?access_token=' + token.accessToken;
  var data = {
    tag: {
      id: id,
      name: name
...
exports.deleteTag = function* (id){
  ...
  var url = this.prefix + 'tags/delete?access_token=' + token.accessToken;
  var data = {
    tag: {
      id: id
    }
 ...
 */
exports.getUsersFromTag = function* (tagId, nextOpenId){
  var token = yield this.ensureAccessToken();
  // https://api.weixin.qq.com/cgi-bin/user/tag/get?access_token=ACCESS_TOKEN
  var url = this.prefix + 'user/tag/get?access_token=' + token.accessToken;
  var data = {
    tagid: tagId,
 ...
 * @param {String} tagId 标签id
 */
exports.batchTagging = function* (openIdList, tagId) {
  var token = yield this.ensureAccessToken();
  // https://api.weixin.qq.com/cgi-bin/tags/members/batchtagging?access_token=ACCESS_TOKEN
  var url = this.prefix + 'tags/members/batchtagging?access_token=' + token.accessToken;
  var data = {
 ...
 * @param {String} tagId 标签id
 */
exports.batchUnTagging = function* (openIdList, tagId) {
  var token = yield this.ensureAccessToken();
  // https://api.weixin.qq.com/cgi-bin/tags/members/batchuntagging?access_token=ACCESS_TOKEN
  var url = this.prefix + 'tags/members/batchuntagging?access_token=' + token.accessToken;
  var data = {
    openid_list: openIdList || [],
    tagid: tagId
  };
 ...
 * ```
 */
exports.getIdList = function* (openId) {
  var token = yield this.ensureAccessToken();
  // https://api.weixin.qq.com/cgi-bin/tags/getidlist?access_token=ACCESS_TOKEN
  var url = this.prefix + 'tags/getidlist?access_token=' + token.accessToken;
  var data = {
    openid: openId
  };
  return yield this.request(url, postJSON(data));
