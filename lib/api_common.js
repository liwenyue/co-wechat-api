...
/**
   ...
   */
  async getAuthorizerInfo (appId, saveToken) {
    let componentAccessToken = await this.ensureComponentToken();
...
class Oauth {
   ...
   */
  constructor({componentAppId, componentAppSecret, getComponentTicket, getComponentToken, saveComponentToken, authorizerAppid, getUserToken, saveUserToken, componentApi, isMiniProgram = false}) {
    ...
    this.component_appsecret = componentApi.componentAppSecret;
...
class API {
   ...
   */
  constructor({componentAppId, componentAppSecret, getComponentTicket, getComponentToken, saveComponentToken, authorizerAppid, getToken, saveToken, componentApi}) {
    if (componentApi && componentApi instanceof ComponentAPI) {
      this.componentApi = componentApi;
    } else if (componentAppId &&  componentAppSecret && getComponentTicket && getComponentToken && saveComponentToken) {
      this.componentApi = new ComponentAPI(componentAppId, componentAppSecret, getComponentTicket, getComponentToken, saveComponentToken)
