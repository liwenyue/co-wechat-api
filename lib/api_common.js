...
class Oauth {
  ...
  async getUserAccessToken (code) {
    ...
    let url = this.getRequestUrl('https://api.weixin.qq.com/sns/oauth2/access_token', params)
  ...
  async refreshUserAccessToken (refreshToken) {
    ...
    let url = this.getRequestUrl('https://api.weixin.qq.com/sns/oauth2/refresh_token', params)
