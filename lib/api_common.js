 ...
 */
var API = function (componentAppid, componentAppSecret, authorizerAppid, getComponentToken, saveComponentToken, getToken, saveToken, componentVerifyTicket, getComponentTicket, authorizerRefreshToken) {
...
API.prototype.getPerAuthCode = function *() {
  let component_access_token = yield this.ensureComponentToken();
