...
API.prototype.getAuthorizeURL = function (redirect, state, scope) {
  return `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${this.appid}&component_appid=${this.component_appid}&response_type=code&scop=${scope || 'snsapi_base'}&state=${state}&redirect_uri=${redirect}#wechat_redirect`;
};
...
API.prototype.getAuthorizeURLForWebsite = function (redirect, state, scope) {
  return `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${this.appid}&component_appid=${this.component_appid}&response_type=code&scop=${scope || 'snsapi_login' }&state=${state}&redirect_uri=${redirect}#wechat_redirect`;
};
